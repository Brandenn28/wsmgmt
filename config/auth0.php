...
return Configuration::VERSION_2 + [
    ...
    'guards' => [
        ...
        'web' => [
            ...
            Configuration::CONFIG_REDIRECT_URI => Configuration::get(Configuration::CONFIG_REDIRECT_URI, env('APP_URL') . '/callback/welcome'),
            Configuration::CONFIG_SESSION_STORAGE => Configuration::get(Configuration::CONFIG_SESSION_STORAGE, env('APP_SESSION_DRIVER', 'cookie')),
    ...
    'routes' => [
        ...
        Configuration::CONFIG_ROUTE_AFTER_LOGIN => Configuration::get(Configuration::CONFIG_ROUTE_AFTER_LOGIN, '/callback/welcome'),
